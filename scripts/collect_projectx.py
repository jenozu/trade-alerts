...
from validate_data import ValidationReport, validate_market_data  # noqa: E402
...
def build_metadata(
    *,
    ...
    return {
        "status": "PASS" if validation.passed and (freshness is None or freshness.fresh) else "FAIL",
